...
function CardDetail(props) {
  return (
    <View style={[styles.container, props.style]}>
      ...
      <BtnDtlUpdate style={styles.materialButtonPrimary}></BtnDtlUpdate>
      <BtdDtlDelete style={styles.materialButtonDanger}></BtdDtlDelete>
      <Text style={styles.designation}>Designation</Text>
      <Text style={styles.prixUnitaire}>Prix Unitaire:</Text>
