...
import UpdateProduit from "./screens/UpdateProduit"
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        ...
        <Stack.Screen name="AjouterProduit" component={AjouterProduit} />
        <Stack.Screen name="UpdateProduit" component={UpdateProduit}/>
